...
def generate_logo(config_path=None):
    ...
    if output_format == "svg":
        return generate_svg_logo(config)
    else:
        return generate_png_logo(config)
...
def generate_svg_logo(config):
    ...
    for char in site_name_text:
        if char == " ":
            ...
            char_width = calculate_char_width(char, site_name_font_path, site_name_font_size)
